...
const equipes = [
  {
    ...
    especialidades: ['Pesquisa quantitativa em larga escala', 'Surveys estruturados', 'Análise estatística rigorosa'],
    supervisao: 'Coordenação direta em campo + supervisão remota do escritório central',
  },
  {
    nome: 'Equipe Paraíba & Rio Grande do Norte',
    base: 'Campina Grande',
    cobertura: 'Toda Paraíba e Rio Grande do Norte, incluindo regiões metropolitanas',
    especialidades: ['Pesquisa quantitativa em larga escala', 'Surveys estruturados', 'Análise estatística rigorosa'],
  ...
  },
  {
    ...
    cobertura: 'Coordenação de pesquisas qualitativas em toda a região de atuação (PE, PB, RN)',
    especialidades: [
