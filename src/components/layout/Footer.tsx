        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-white/70 hover:text-brand-amber text-sm transition-colors"
                >
              ...
              <li>
                <a
                  href="mailto:voxanalitica1@gmail.com"
                  className="flex items-center gap-2 text-white/70 hover:text-brand-amber text-sm transition-colors"
                >
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  voxanalitica1@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://www.instagram.com/voxanalitica.br/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white/70 hover:text-brand-amber text-sm transition-colors"
                >
              ...
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=61579455456761"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white/70 hover:text-brand-amber text-sm transition-colors"
                >
